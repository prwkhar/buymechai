...
export default function Home() {
  return (
    <>
      <div className="flex justify-center flex-col gap-4 items-center text-white min-h-screen px-5 md:px-0 text-xs md:text-base  ">
        <div className="font-bold flex  md:text-5xl justify-center items-center text-3xl">
          <div className="text-center pt-4">Get Me a Chai</div>
      ...
      <div className="text-white container mx-auto h-97 pb-32 pt-14 px-10">
